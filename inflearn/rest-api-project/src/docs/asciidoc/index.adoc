...
operation::create-event[snippets='request-body,request-fields,curl-request,http-request,response-body,request-headers,http-response,response-headers,response-fields,links']

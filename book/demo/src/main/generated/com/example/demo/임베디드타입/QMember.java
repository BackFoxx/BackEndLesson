...
public class QMember extends EntityPathBase<Member> {
    ...
    private static final long serialVersionUID = 1469247589L;
    ...
    public QMember(Class<? extends Member> type, PathMetadata metadata, PathInits inits) {
        ...
        this.companyAddress = inits.isInitialized("companyAddress") ? new QAddress(forProperty("companyAddress"), inits.get("companyAddress")) : null;
        this.homeAddress = inits.isInitialized("homeAddress") ? new QAddress(forProperty("homeAddress"), inits.get("homeAddress")) : null;
